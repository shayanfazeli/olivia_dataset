...
from olivia_dataset.fetching.hrsa.health_center_program_participants import retrieve_health_center_program_participants
...
if __name__ == "__main__":
    ...
    logger.info(">> [update in progress]: HRSA State-level Health Center Program Participants")
    retrieve_health_center_program_participants()
